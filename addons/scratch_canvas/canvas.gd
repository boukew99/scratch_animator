...
signal drawing()
export(PackedScene) var layer = preload("res://addons/scratch_canvas/layer.tscn")
export(Array, PackedScene) var lines = [preload("res://addons/scratch_canvas/line.tscn")]
